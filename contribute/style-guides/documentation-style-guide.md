...
The following guidelines are specific to Grafana documentation. For the most part, these are *guidelines* and not rigid rules. If you have questions, then please ask in the #docs channel of Grafana Slack.
